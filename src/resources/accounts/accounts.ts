...
import * as AccountsAPI from 'meorphis-test-30/resources/accounts/accounts';
import * as CreditConfigurationAPI from 'meorphis-test-30/resources/accounts/credit-configuration';
