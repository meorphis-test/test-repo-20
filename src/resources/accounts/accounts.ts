...
import * as AccountsAPI from '@stainless-temp/meorphis-test-31/resources/accounts/accounts';
import * as CreditConfigurationAPI from '@stainless-temp/meorphis-test-31/resources/accounts/credit-configuration';
