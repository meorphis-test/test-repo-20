...
import * as CardsAPI from '@stainless-temp/meorphis-test-31/resources/cards/cards';
import * as FinancialTransactionsAPI from '@stainless-temp/meorphis-test-31/resources/cards/financial-transactions';
